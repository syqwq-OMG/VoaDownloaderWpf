...
namespace SQL
{
	...
	public class SQLHelper
	{
        ...
        // Add this new static method to your existing SQLHelper class in SQLHelper.cs

        /// <summary>
        /// A new static method to execute a non-query SQL command.
        /// This makes it easy to call from other parts of the application without managing an instance of SQLHelper.
        /// </summary>
        /// <param name="cmdText">The SQL command text to execute.</param>
        /// <param name="prams">The parameters for the SQL command.</param>
        /// <returns>The number of rows affected.</returns>
        public static int ExecuteNonQuery(string cmdText, SqlParameter[] prams)
        {
            // Create an instance of the helper class
            SQLHelper helper = new SQLHelper();

            // Call the existing instance method 'RunSQL' to execute the command
            // This leverages the connection management and command creation logic you already have.
            return helper.RunSQL(cmdText, prams);
        }
    }
}
